...
@Language.factory("phrase_detector", default_config={"phrase_min_words_count": 2,
                                                     "phrase_max_words_count": 6,
                                                     "attrs": ("phrases",), })
def create_phrase_chunker_component(nlp: Language, name: str, phrase_min_words_count: int, phrase_max_words_count: int,
                                    attrs: Tuple[str]) -> PhraseDetector:
    return PhraseDetector(phrase_min_words_count, phrase_max_words_count, attrs)
