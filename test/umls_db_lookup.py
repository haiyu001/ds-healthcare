...
class UMLSLookup(object):
    ...
    def lookup_code(self, cui: Optional[str], preferred: bool = True) -> List[Tuple[str, str, str]]:
    ...
    def lookup_code_meaning(self, cui: str, preferred: bool = True, no_html: bool = True) -> str:
    ...
    def lookup_code_for_name(self, name: Optional[str], preferred: bool = True) -> List[Tuple[str, str, str]]:
    ...
    def lookup_sementic_type_name_and_group(self, semantic_type_ids) -> str:
...
if "__main__" == __name__:
    ...
    concept_id = "C0008115" # "C0008115" # "C0027051"
